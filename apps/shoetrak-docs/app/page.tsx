...
export default function Page(): JSX.Element {
  return (
<<<<<<< Updated upstream:apps/shoetrak-docs/app/page.tsx
    <main className={styles.main}>
      <div className={styles.description}>
        <p>
          examples/basic&nbsp;
          <Code className={styles.code}>shoetrak-docs</Code>
        </p>
        <div>
          <a
...
=======
    <h1 className="text-red-500">Doc</h1>
>>>>>>> Stashed changes:apps/docs/app/page.tsx
  );
}
