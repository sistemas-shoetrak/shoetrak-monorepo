...
export default function Page(): JSX.Element {
  return (
<<<<<<< Updated upstream:apps/shoetrak-app/app/page.tsx
    <main className={styles.main}>
      <div className={styles.description}>
        <p>
          examples/basic&nbsp;
          <Code className={styles.code}>shoetrak-app</Code>
        </p>
        <div>
          <a
      ...
      <Button appName="shoetrak-app" className={styles.button}>
        Click me!
      </Button>
...
=======
    <>
     <h1 className="scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl">Web</h1>
      <Button variant="default">Click</Button>
    </>
>>>>>>> Stashed changes:apps/web/app/page.tsx
  );
}
